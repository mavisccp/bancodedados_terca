...
O sistema deve cadastrar clientes incluindo as informações: nome, CPF/CNPJ, telefone, endereço,e-mail, cidade e estado. Geradores: manutenções, serviços e técnicos. 
